---
title: "Supplementary Data for 'Semantic computing for human phenotypes'"
...
## Source code for manuscript and analyses

Our paper was written using bookdown @bookdown and the markup is contained in the gwasCatSearch package available on GitHub, <https://github.com/ccb-hms/gwasCatSearch>. Within that repository, in the vignettes folder are all the documents needed to reproduce this paper.  All details for the paper are given explicitly in the file `GWAScatPaper.Rmd` and in `gwasCatSupplement.Rmd` for the supplement. They can be modified and extended by any interested reader.


## Database infrastructure: GWASCatalogSearchDB
...
knitr::include_graphics("figures/GWASCat.png")
```
