...
names(ptab)[10] = "10+"
kable_styling(kbl(ptab, col.names=c("Count"), caption="Number of EFO terms per Study"), bootstrap_options = "striped", full_width = FALSE)
```
...
FIXME: here trying to figure out what is going on..
```{r msmt, echo=TRUE}
...
FIXME- the matches are largely in the measurement area - see above
