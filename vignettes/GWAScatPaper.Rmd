...
In Figure \@ref{fig:efograph}

```{r efograph, echo=FALSE, fig.cap = "Rendering of the EFO Ontology for urinary system disease and descendents.", label="EFOgraph", fig.align='center'}
