...
```{r lookupSNP}
lu1 = variants_from_study(allmatch$STUDY.ACCESSION[1])
lu1$MAPPED_GENE
...
```{r plotContext, echo=FALSE, eval=FALSE}
view_variant_context(chr=lu1$seqnames[1], pos=lu1$start[1], radius=5e+05,
                     gwdat=gwc_gr, main="Manhattan Plot")
```
