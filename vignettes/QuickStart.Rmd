...
ht3 = search_features(efo_tc, query = "\"autoimmune disease\"")
...
gg = grepl("*EFO_0005140", am[,4])
am[gg,]
```

We can compare with what the `gwasrapidd` vignette. Somehow even though the `study_ids` are unique, the PubMed Ids and titles are not.
