...
on broader semantic matching using term relationships in the EFO.  Each study in the GWAS catalog identifies one or more (FIXME:VINCE  not sure what the one in user selects one, refers to one what?) replicated SNP associations.  The user selects one, and then all catalog-replicated GWAS hits within a 1000kb window of this index
